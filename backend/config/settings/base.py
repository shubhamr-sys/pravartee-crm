"""
Base settings for Pravartee CRM.
...
# Database — PostgreSQL 16+ (see deployment/postgresql/README.md)
...
# Custom user — must remain "accounts.User"; see apps/accounts/MIGRATION_STRATEGY.md
...
CORS_ALLOWED_ORIGINS = config(
    ...
    default="http://localhost:3034,http://127.0.0.1:3034",
    cast=Csv(),
)
